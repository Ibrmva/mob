              ...
              children: [
                ...
                const SizedBox(
                  ...
                  child: Text(
                      ...
                      \nThis is the perfect place to relax for you and your family. We are waiting for you to visit, to accumulate memories in your memory piggy bank.""", style: TextStyle(color: Colors.white),),
                ),
                const SizedBox(
                  height: 20,
                ),
                Row(
                  ...
                  children: [
                    Image.asset(Images.image7, width: 95,height: 95,),
                    const SizedBox(
                      width: 9,
                    ),
                    const Column(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        SizedBox(width: 216, child: Text("Maison\nHOTEL & RESTAURANT", style: TextStyle(color: Colors.white),)),
                        SizedBox(width: 216, child: Text("Our hotel is located just a five-minute walk from the beach so you can immerse yourself in fresh waters and indulge in the sunshine. Don't worry about water and electricity - we have an uninterrupted supply!", style: TextStyle(color: Colors.white),))
                      ],
                    )
                  ],
                ),
...
Have a good rest!""", style: TextStyle(color: Colors.white),),
                ),
                Padding(
                  ...
                  children: [
                    Row( 
                      children: [
                        ...
                        const Text(
                          """Location\nNear to the Ferris Wheel, p. Bosteri""",
                          style: TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                            fontSize: 10
                ...
                Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Image.asset(Images.image11, width: 95,height: 95,),
                        const SizedBox(
                          width: 17,
                        ),
                        const SizedBox(
...
\nAnd we will be happy to help you with this\n\nContacts:\n+996 501 799 977\ninstagram:\nmaison.ik""", style: TextStyle(color: Colors.white),
                          ),
                        )
                      ],
                    ),
